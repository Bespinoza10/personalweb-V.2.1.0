  ...
  <body data-spy="scroll" data-target="navbar-nav">
    ...
    <div id="iDo" class="iDo col-md-12 col-lg-12">
      ...
      <div class="container">
        <div class="col-lg-12 elemMargins">
          <div class="col-lg-3 squares wow bounceInUp " data-wow-offset="10" data-delay=".5s">
          ...
          <div class="col-lg-offset-1 col-lg-3 squares wow bounceInUp " data-wow-offset="10" data-delay=".7s">
          ...
          <div class="col-lg-offset-1 col-lg-3 squares wow bounceInUp " data-wow-offset="10" data-delay=".9 s">
    ...
    <div id="clients" class=" col-md-12 col-lg-12">
      ...
      <div class="container cont">
        <div class="row">
          <div class="col-sm-3 col-lg-3 wow rubberBand" data-wow-offset="10" data-wow-delay=".8s">
            <a target="_blank" href="http://www.brotherwindows.com"><img class="img-responsive" src="img/portfolio/clearchoice_logo3.png"></a>
          </div>
          <div class="col-sm-offset-1 col-sm-3 col-lg-3 wow rubberBand" data-wow-offset="10" data-wow-delay="1s">
            <a target="_blank" href="http://www.cheffitpro.com"><img class="img-responsive" src="img/portfolio/ChefItLOGO.png"></a>
          </div>
          <div class="col-sm-offset-1 col-sm-3 col-lg-3 wow rubberBand" data-wow-offset="10" data-wow-delay="1.2s">
